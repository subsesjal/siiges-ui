...
export default function DocumentsStudents({ id }) {
  ...
  return (
    <Stack direction="row" spacing={1}>
      ...
      <Tooltip title="Ver Acta de Nacimiento" placement="top">
        <IconButton
          onClick={() => handleVerDocumento('ARCHIVO_NACIMIENTO')}
          color="gray"
        >
          <PictureAsPdfIcon />
        </IconButton>
      </Tooltip>
      <Tooltip title="Ver CURP" placement="top">
        <IconButton
          onClick={() => handleVerDocumento('ARCHIVO_CURP')}
          color="gray"
        >
          <PictureAsPdfIcon />
        </IconButton>
