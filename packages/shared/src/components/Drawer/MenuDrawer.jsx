                    ...
                    <ListItem key="users" disablePadding sx={{ display: 'block' }}>
                        <Link href="/users">
                            ...
                            >
                                ...
                                <ListItemText primary="Mis usuarios" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </Link>
                    </ListItem>
                    <ListItem key="intitutions" disablePadding sx={{ display: 'block' }}>
                        <Link href="/institution">
                            ...
                            >
                                ...
                                <ListItemText primary="Mi institucion" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </Link>
                    </ListItem>
                    <ListItem key="solicitudes" disablePadding sx={{ display: 'block' }}>
                        <Link href="/home">
                            ...
                            >
                                ...
                                <ListItemText primary="Mis solicitudes" sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </Link>
                    </ListItem>
                </List>
