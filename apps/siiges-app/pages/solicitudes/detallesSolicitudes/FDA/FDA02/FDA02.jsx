...
var turnoTipo = tiposDeTurno.join(", ");
  ...
  const tableData = [
    [nombreNivel, turnoTipo, modalidadTipo, ciclosTipo]
  ];
  ...
  const tablaData1 = {
    ...
    body: [
      [solicitud.programa.plantel.domicilio.calle + '  ' + solicitud.programa.plantel.domicilio.numeroExterior , solicitud.programa.plantel.domicilio.colonia],
    ],
  };
  
  crearSeccionConTabla1(doc, "DOMICILIO DE LA INSTITUCIÓN", tablaData1, { spaceBeforeTable: 7 });
  ...
  const tableData2 = [
    [solicitud.programa.plantel.domicilio.codigoPostal, solicitud.programa.plantel.domicilio.municipio.nombre, solicitud.programa.plantel.domicilio.estado.nombre]
  ];
  ...
  const tableData6 = [
    [solicitud.programa.plantel.domicilio.calle + '  ' + solicitud.programa.plantel.domicilio.numeroExterior,solicitud.programa.plantel.domicilio.estado.nombre]
  ];
